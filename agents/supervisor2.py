...
from utils.tracing import setup_langsmith_tracing, trace_agent, trace_llm_call
...
#@trace_agent("build_supervisor_graph")
...
#@trace_agent("data_fetcher_with_memory")
...
#@trace_agent("insights_with_memory")
...
#@trace_agent("knowledge_with_memory")
def knowledge_node_with_memory(state: AgentState) -> AgentState:
    ...
    try:
        ...
        return {**state}
print("SQL Agent sees GROQ:", os.getenv("GROQ_API_KEY"))
